...
public class CityDepths extends CustomDungeon {
    public static final String ID = "CityDepths";
    ...
    public CityDepths(CustomDungeon cd, AbstractPlayer p, ArrayList<String> emptyList) {
        super(cd, p, emptyList);
    }
    
    public CityDepths(CustomDungeon cd, AbstractPlayer p, SaveFile sf) {
        super(cd, p, sf);
    }
    ...
    protected void generateMonsters() {
        monsterList.clear();
        monsterList.add(King.Encounter.CITY_DEPTHS_ELITE);
        monsterList.add(King.Encounter.CITY_DEPTHS_ELITE);
        monsterList.add(King.Encounter.CITY_DEPTHS_ELITE);
        eliteMonsterList.clear();
        eliteMonsterList.add(King.Encounter.CITY_DEPTHS_ELITE);
        eliteMonsterList.add(King.Encounter.CITY_DEPTHS_ELITE);
        eliteMonsterList.add(King.Encounter.CITY_DEPTHS_ELITE);
    }
