...
public class DecaCardCounterPower extends AbstractSEPower {
    public static final String ID = King.MakeID("DecaCardCounterPower");
    private final int counter;
    
    public DecaCardCounterPower(AbstractCreature owner, int counter) {
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (card != null && isCardTypeOf(card, AbstractCard.CardType.SKILL)) {
            amount++;
        }
